 ...
 */
public class AlertJacksonSerdeCustomStickyProducer {
    private static final Logger log = LoggerFactory.getLogger(AlertJacksonSerdeCustomStickyProducer.class);
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        kafkaProps.put(ProducerConfig.PARTITIONER_CLASS_CONFIG, MyStickyPartitioner.class);
