...
public class AlertGsonSerdeProducer {
    private static final Logger log = LoggerFactory.getLogger(AlertGsonSerdeProducer.class);
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        kafkaProps.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, GsonSerde.class.getName());
