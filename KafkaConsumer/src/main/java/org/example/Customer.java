...
public class Customer extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    private static final long serialVersionUID = 7804491386440591478L;
    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Customer\",\"namespace\":\"org.example\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
     ...
     */
    public static org.example.Customer.Builder newBuilder() {
        return new org.example.Customer.Builder();
    }
     ...
     * @return A new Customer RecordBuilder
     */
    public static org.example.Customer.Builder newBuilder(org.example.Customer.Builder other) {
        if (other == null) {
            return new org.example.Customer.Builder();
        } else {
            return new org.example.Customer.Builder(other);
        }
    }
     ...
     * @return A new Customer RecordBuilder
     */
    public static org.example.Customer.Builder newBuilder(org.example.Customer other) {
        if (other == null) {
            return new org.example.Customer.Builder();
        } else {
            return new org.example.Customer.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Customer>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(org.example.Customer.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(org.example.Customer other) {
            super(SCHEMA$);
            if (isValidValue(fields()[0], other.id)) {
                this.id = data().deepCopy(fields()[0].schema(), other.id);
         ...
         * @return This builder.
         */
        public org.example.Customer.Builder setId(long value) {
         ...
         * @return This builder.
         */
        public org.example.Customer.Builder clearId() {
         ...
         * @return This builder.
         */
        public org.example.Customer.Builder setName(java.lang.String value) {
         ...
         * @return This builder.
         */
        public org.example.Customer.Builder clearName() {
            name = null;
